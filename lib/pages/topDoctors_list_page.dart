    ...
    return Scaffold(
     backgroundColor: Colors.white,
      appBar: AppBar(
        ...
        title: const Text("Top Doctors",style: TextStyle(color: Color(0xFF101623),fontSize: 16,fontWeight: FontWeight.w600),),
      ...
      body: Padding(
        ...
        child: InkWell(
          onTap: ()=>Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const DoctorDetailPage())),
          child: ListView.separated(
              itemBuilder: (BuildContext context,int index){

                return const CustomDoctorWidget();
              }, separatorBuilder: (BuildContext context,int i){return const SizedBox(height: 16);}, itemCount: 12),
        ),
      ),
    );
  }
